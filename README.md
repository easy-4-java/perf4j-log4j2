...
[![Java](https://img.shields.io/badge/Java-17-orange)](https://github.com/easy-4-java/perf4j-log4j2) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)

perf4j-log4j2 ports the Perf4J timing library to Log4j 2.x
...
```groovy
implementation 'io.github.easy4j:perf4j-log4j2:2.0.x.x.20260630-SNAPSHOT'
```
